var AestheticIconPicker = function(option) {
	...
	document.querySelector(defaultOpt.onClick).addEventListener('click', function (e) {
		...
		aestheticDomEle.querySelector('.aim-insert-icon-button').addEventListener('click', function (e) {
			...
			if (null !== selected) {
				...
				document.querySelector('#easyelements-menu-icon-field').value = sellectedClass;

				var wrap = document.querySelector('.ele-select-icon');
	...
	document.querySelector('.icon-none').addEventListener('click', function (e) {
		var selected = document.querySelector('.aesthetic-selected');
		document.querySelector('.ele-select-icon i').classList.value = 'fas fa-circle';
	...
	return {
		reload: function () {
			var selectedIcon = document.querySelector('#easyelements-menu-icon-field').value;
			var wrap = document.querySelector('.ele-select-icon');

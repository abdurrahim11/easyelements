  ...
  const ElementCopyPasteHandler = {
    ...
    pasteAllSections: function(allSections) {
      jQuery.ajax({
        ...
        if (response.success) {
          const data = response.data[0];
          const targetView = premium_cross_cp.elementorCompatible ? elementor.sections.currentView : elementor.previewView;
        ...
        groups.push({
          ...
          actions: [{
            ...
            callback: function() {
              ...
              xdLocalStorage.setItem("premium-c-p-element", JSON.stringify(copiedElementData), function() {
                elementor.notifications.showToast({
          ...
          },
            {
              ...
              callback: function() {
                ...
                xdLocalStorage.setItem('premium-c-p-all', JSON.stringify(allSections), function() {
                  elementor.notifications.showToast({
                    message: elementor.translate('Copied')
                  });
                });
            ...
            },
            {
              ...
              callback: function() {
                let allSections = '';
                xdLocalStorage.getItem('premium-c-p-all', function(item) {

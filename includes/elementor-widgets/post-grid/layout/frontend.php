...
<div class="cbp-item ele-post-grid-item">
	<?php if ( has_post_thumbnail() && 'yes' === $settings['show_image'] ) : ?>
		<div class="ele-post-grid-image">
			...
			<?php if ( 'yes' === $settings['show_readmore'] && '3' === $settings['layout'] ) : ?>
				<a href="<?php echo esc_url( get_permalink( $post->ID ) ); ?>" class="ele-post-grid-btn"><?php echo esc_html( $settings['readmore_text'] ); ?></a>
			<?php endif; ?>
		</div>
	<?php endif; ?>
	...
	<div class="ele-post-grid-content">
		...
		<?php if ( 'yes' === $settings['show_content'] ) : ?>
			<p class="ele-post-grid-excerpt"><?php ele_kses( $content ); ?></p>
		<?php endif; ?>
		<?php if ( 'yes' === $settings['show_readmore'] && '3' !== $settings['layout'] ) : ?>
			<a href="<?php echo esc_url( get_permalink( $post->ID ) ); ?>" class="ele-post-grid-btn"><?php echo esc_html( $settings['readmore_text'] ); ?></a>
		<?php endif; ?>
			...
			<div class="ele-post-grid-author">
				...
				<div class="ele-post-grid-author-content">
					<?php if ( $settings['author_title'] ) : ?>
						<span class="ele-post-grid-author-title"><?php echo esc_html( $settings['author_title'] ); ?></span>
					<?php endif; ?>

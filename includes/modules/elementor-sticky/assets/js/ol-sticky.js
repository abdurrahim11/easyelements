(function ( $, elementorFrontend ) {
    ...
    /**
     * Helper object for initializing sticky behavior
     */
    var ele_sticky_helper = {
        init:function() {
            ...
            initialize = function(markup, options) {
                ...
                /**
                 * Function to animate CSS properties
                 */
                ...
                /**
                 * Function to create CSS properties from backup
                 */
                ...
                /**
                 * Function to show sticky element
                 */
                var show = function() {
                ...
                /**
                 * Function to check CSS properties
                 */
                ...
                /**
                 * Function to hide sticky element
                 */
                var hide = function() {
                ...
                /**
                 * Function to save element state
                 */
                var save = function() {
                    toggle();
                ...
                /**
                 * Initialization function for sticky parent
                 */
                var init = function() {
                ...
                /**
                 * Function to render sticky behavior
                 */
                var render = function() {
                    var translateY;
                ...
                // Function to start sticky behavior
                var start = function() {
                    if (is_sticky) {
                        toggle();
                        show();
                ...
                // Function to destroy sticky behavior
                ...
                //Extend descriptor with options
                self = jQuery.extend(true, descriptor, options);
                // Get the node and set window
                ...
                // Render sticky behavior
                render();
            };

            $.fn.sticky_element_handler = function(method) {
        ...
        Sticky_Handler: elementorModules.frontend.handlers.Base.extend({
            ...
            activate: function() {
                var self_settings = this.getElementSettings();
                var revision_checkbox = $("#" + self_settings.ele_sticky_until);
                var options = {
                    to: self_settings.ele_sticky,
                    offset: self_settings.ele_sticky_offset.size,
                    effects_offset: self_settings.ele_sticky_effect_offset.size,
                    classes: {
                        sticky: "ele-sticky",
                        sticky_active: "ele-sticky--active ele-section--handles-inside",
                        sticky_effects: "ele-sticky--effects",
                        spacer: "ele-sticky__spacer"
                    },
                    stop_at: !!revision_checkbox.length && revision_checkbox
                };
                var admin_bar = elementorFrontend.getElements("$wpAdminBar");
                if ("column" === self_settings.ele_sticky) {
                    options.to = "top";
                    options.column = true;
                }
                if ("show_on_scroll_up" === self_settings.ele_sticky) {
                    options.to = "top";
                    options.is_show_on_scroll_up = true;
                }
                if (self_settings.ele_sticky_parent) {
                ...
                if (admin_bar.length) {
                    if ("top" === self_settings.ele_sticky) {
                        if ("fixed" === admin_bar.css("position")) {
                            options.offset += admin_bar.height();
                        }
                    }
                }
                this.$element.sticky_element_handler(options);
            },
            deactivate: function() {
                if (this.is_sticky_on()) {
                    this.$element.sticky_element_handler("destroy");
                }
            },
            run: function(data_and_events) {
                if (this.getElementSettings("ele_sticky")) {
                    var search_string = elementorFrontend.getCurrentDeviceMode();
                    ...
                    if (-1 !== str.indexOf(search_string)) {
                        if (true === data_and_events) {
                            this.reactivate();
                        } else {
                            if (!this.is_sticky_on()) {
                                this.activate();
    ...
    /**
     * Main initialization object for sticky behavior
     */
    var ele_sticky = {
        init: function() {
    ...
    /**
     *  Initialize sticky behavior when Elementor frontend is ready
     */

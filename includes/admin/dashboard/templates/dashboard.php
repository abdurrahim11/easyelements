    ...
    <div class="ee-welcome-dashboard">
        ...
        <div class="ee-body-content-wrapper">
            <div class="ee-body-content-left">
                <div class="ee-support-info-wrapper">
                    <a href="#" target="_blank" class="ee-support-item ee-box-shadow" title="Technical Support">
                        <img src="<?php echo esc_url( ELE_PLUGIN_URL . 'assets/admin/' );?>images/Email-Support-icon.svg" alt="" />
                        <h3>Technical Support</h3>
                    </a>
                    <a href="#" target="_blank" class="ee-support-item ee-box-shadow" title="Support Forum">
                        <img src="<?php echo esc_url( ELE_PLUGIN_URL . 'assets/admin/' );?>images/Support-Forum-icon.svg" alt="" />
                        <h3>Support Forum</h3> 
                    </a>
                    <a href="#" target="_blank" class="ee-support-item ee-box-shadow"  title="Documentation">
                        <img src="<?php echo esc_url( ELE_PLUGIN_URL . 'assets/admin/' );?>images/documentation.svg" alt="" />
                        <h3>Documentation</h3>
                    </a>
                </div>
                <div class="ee-video-tutorial-wrapper ee-box-shadow">
                    <div class="ee-video-tutorial-header">
                        <div class="ee-video-header-left">
                            <div class="ee-video-header-left-icon">
                                <img src="<?php echo esc_url( ELE_PLUGIN_URL . 'assets/admin/' );?>images/video.svg" alt="" />
                            </div>
                        ...
                        <div class="ee-video-header-right">
                            <a href="#" target="_blank" class="ee-button">View More</a>
                        </div>
                    </div>
                    <div class="ee-video-tutorials-wrapper">
                        
                        <div class="ee-video-tutorial-item ee-videoButton" data-video="https://www.youtube.com/embed/Un2xfFZPsio?si=4okgg0oNDOM0WLyH">
                            <img src="<?php echo esc_url( ELE_PLUGIN_URL . 'assets/admin/' );?>images/video-1.png" alt="" />
                            <button class="ee-video-play-button">
                                <img src="<?php echo esc_url( ELE_PLUGIN_URL . 'assets/admin/' );?>images/play.svg" alt="" />
                            </button>
                            <h3>How to use?</h3>
                            <div id="ee-videoPopup" class="ee-popup">
                                <div class="ee-popup-content">
                                    <span class="ee-close">&times;</span>
                                    <iframe id="ee-videoIframe" width="840" height="472" src="" frameborder="0" allow="autoplay; encrypted-media" allowfullscreen></iframe>
                                </div>
                            </div>
                            
                        </div>
                        <div class="ee-video-tutorial-item ee-videoButton" data-video="https://www.youtube.com/embed/k8FLT9y0KbU?si=V671B7-fuh3zbZv8">
                            <img src="<?php echo esc_url( ELE_PLUGIN_URL . 'assets/admin/' );?>images/video-1.png" alt="" />
                            <button class="ee-video-play-button">
                                <img src="<?php echo esc_url( ELE_PLUGIN_URL . 'assets/admin/' );?>images/play.svg" alt="" />
                            </button>
                        ...
                        <div class="ee-video-tutorial-item ee-videoButton" data-video="https://www.youtube.com/embed/xlElO06nQy8?si=_G0hkCrIgKvf3ZT0">
                            <img src="<?php echo esc_url( ELE_PLUGIN_URL . 'assets/admin/' );?>images/video-1.png" alt="" />
                            <button class="ee-video-play-button">
                                <img src="<?php echo esc_url( ELE_PLUGIN_URL . 'assets/admin/' );?>images/play.svg" alt="" />
                            </button>
            ...
            <div class="ee-body-content-right">
                <div class="ee-feature-request-wrapper">
                    <div class="ee-feature-request-header">
                        <img src="<?php echo esc_url( ELE_PLUGIN_URL . 'assets/admin/' );?>images/request.svg" alt="" />
                        <h3 class="ee-secondery-heading">Request a Feature</h3>
                    </div>
                    <p class="ee-secondery-p">
                    Missing something? Share your IDEA/Requirements with us, drop us an feature topic and your feature description.
                    </p>
                    <a class="ee-button" href="#" target="_blank">Request a Feature</a>
                </div>
                <div class="ee-live-copy-paste-wrapper ee-box-shadow">
                    <div class="ee-live-copy-paste">
                        <img src="<?php echo esc_url( ELE_PLUGIN_URL . 'assets/admin/' );?>images/copy.svg" alt="" />
                        <h3 class="ee-secondery-heading">Live Copy Paste</h3>
                    </div>
                    <p class="ee-secondery-p">
    ...
    <div class="ee-elements-dashboard ee-box-shadow">
        ...
        <div class="ee-elements-header-switcher-controls">
            <div class="ee-elements-header-switcher-control">
                ...
                <div class="ee-elements-header-switcher ee-secondery-p">Enable All</div>
            </div>
            <div class="ee-elements-header-save-settings">
                <button class="ee-button">Save Settings</button>
            </div>
        </div>
    </div>
...
<div id="system" class="ee-body-wrapper">
    <div class="ee-elements-dashboard-wrapper">
        <div class="ee-elements-dashboard ee-box-shadow">
            <div class="ee-system-info-list" role="region" tabindex="0">
                <table>
                    <thead class="ee-secondery-p">
                        <tr>
                            <th colspan="2">WordPress Environment</th>
                            
                        </tr>
                    </thead>
                    <tbody class="ee-secondery-p">
                        <tr>
                            <td>Home URL:</td>
                            <td>http://easyelementspro.com/</td>
                        </tr>
                        <tr>
                            <td>Site URL:</td>
                            <td>http://library.easyelementspro.com/</td>
                        </tr>
                        <tr>
                            <td>WP Version:</td>
                            <td>6.5.5</td>
                        ...
                        <tr>
                            ...
                            <td>40 MB - We recommend setting wp memory at least 64MB.</td>
                        </tr>
                        <tr>
                            <td>WP Path:</td>
                            <td>C:\xampp\htdocs\easyelements/</td>
                        </tr>
                        <tr>
                            <td>WP Debug Mode:</td>
                            <td>N/A</td>
        ...
        <div class="ee-system-info-list" role="region" tabindex="0">
                <table>
                    ...
                    <tbody class="ee-secondery-p">
                        <tr>
                            <td>Server Info:</td>
                            <td>Apache/2.4.58 (Win64) OpenSSL/3.1.3 PHP/8.2.12</td>
                        </tr>
                        <tr>
                            <td>PHP Version:</td>
                            <td>8.2.12</td>
...
<div id="support" class="ee-body-wrapper">
    <div class="ee-elements-dashboard-wrapper ee-support">
        <div class="ee-feature-request-wrapper">
            <div class="ee-feature-request-header">
                <img src="<?php echo esc_url( ELE_PLUGIN_URL . 'assets/admin/' );?>images/request.svg" alt="" />
                <h3 class="ee-secondery-heading">Request Features</h3>
            </div>
            <p class="ee-secondery-p">Enhance your website with our custom Elementor plugin. Get tailored features, advanced styling, responsive design, and seamless integration. Choose instant feature deployment or benefit from regular free updates. Transform your site with interactive elements and dynamic content.</p>
            <ul class="ee-secondery-p ee-mb-24 ee-white ee-support-features">
                <li>Tailored Solutions</li>
                <li>Rapid Deployment for an additional charge</li>
                <li>Free Updates for essential features</li>
            </ul>
            <a class="ee-button" href="https://wa.me/+8801518376775" target="_blank">Request a Feature</a>
        </div>

        <div class="ee-live-copy-paste-wrapper ee-box-shadow">
            <div class="ee-live-copy-paste">
            <img src="<?php echo esc_url( ELE_PLUGIN_URL . 'assets/admin/' );?>images/request.svg" alt="" />
                <h3 class="ee-secondery-heading">Technical Support</h3>
            </div>
            <p class="ee-secondery-p">We provide dedicated technical support for our custom Elementor plugin. Get expert assistance for troubleshooting, feature customization, and seamless updates. Contact us for prompt and reliable support!</p>
            <ul class="ee-secondery-p ee-mb-24 ee-support-features">
                <li>Tailored Solutions</li>
                <li>Rapid Deployment for an additional charge</li>
                <li>Free Updates for essential features</li>
            </ul>
            <a class="ee-button" href="https://wa.me/+8801518376775" target="_blank">Get support</a>
        </div>
    </div>
</div> 
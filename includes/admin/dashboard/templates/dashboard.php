    ...
    <div class="ele-elements-dashboard-wrapper">
            ...
            <div class="ele-system-info-list" role="region" tabindex="0">
                <table>
                    <thead class="ele-secondery-p">
                        <tr>
                            <th colspan="2"><?php esc_html_e( 'WordPress Environment', 'easy-elements' ); ?></th>
                        </tr>
                    </thead>
                    <tbody class="ele-secondery-p">
                        <tr>
                            <td><?php esc_html_e( 'Home URL:', 'easy-elements' ); ?></td>
                            <td><?php echo esc_html( 'http://easyelementspro.com/' ); ?></td>
                        </tr>
                        <tr>
                            <td><?php esc_html_e( 'Site URL:', 'easy-elements' ); ?></td>
                            <td><?php echo esc_html( 'http://library.easyelementspro.com/' ); ?></td>
                        </tr>
                        <tr>
                            <td><?php esc_html_e( 'WP Version:', 'easy-elements' ); ?></td>
                            <td><?php echo esc_html( '6.5.5' ); ?></td>
                        </tr>
                        <tr>
                            <td><?php esc_html_e( 'WP Multisite:', 'easy-elements' ); ?></td>
                            <td><?php esc_html_e( 'N/A', 'easy-elements' ); ?></td>
                        </tr>
                        <tr>
                            <td><?php esc_html_e( 'WP Memory Limit:', 'easy-elements' ); ?></td>
                            <td><?php esc_html_e( '40 MB - We recommend setting wp memory at least 64MB.', 'easy-elements' ); ?></td>
                        </tr>
                        <tr>
                            <td><?php esc_html_e( 'WP Path:', 'easy-elements' ); ?></td>
                            <td><?php echo esc_html( 'C:\xampp\htdocs\easyelements/' ); ?></td>
                        </tr>
                        <tr>
                            <td><?php esc_html_e( 'WP Debug Mode:', 'easy-elements' ); ?></td>
                            <td><?php esc_html_e( 'N/A', 'easy-elements' ); ?></td>
                        </tr>
                        <tr>
                            <td><?php esc_html_e( 'Language:', 'easy-elements' ); ?></td>
                            <td><?php echo esc_html( 'en_US' ); ?></td>
                        </tr>
                    </tbody>
                </table>
            </div>
        ...
        <div class="ele-system-info-list" role="region" tabindex="0">
                <table>
                    <thead class="ele-secondery-p">
                        <tr>
                            <th colspan="2"><?php esc_html_e( 'Server Environment', 'easy-elements' ); ?></th>
                        </tr>
                    </thead>
                    <tbody class="ele-secondery-p">
                        <tr>
                            <td><?php esc_html_e( 'Server Info:', 'easy-elements' ); ?></td>
                            <td><?php echo esc_html( 'Apache/2.4.58 (Win64) OpenSSL/3.1.3 PHP/8.2.12' ); ?></td>
                        </tr>
                        <tr>
                            <td><?php esc_html_e( 'PHP Version:', 'easy-elements' ); ?></td>
                            <td><?php echo esc_html( '8.2.12' ); ?></td>
                        </tr>
                        <tr>
                            <td><?php esc_html_e( 'PHP Memory Limit:', 'easy-elements' ); ?></td>
                            <td><?php echo esc_html( '512 MB' ); ?></td>
                        </tr>
                        <tr>
                            <td><?php esc_html_e( 'PHP Post Max Size:', 'easy-elements' ); ?></td>
                            <td><?php echo esc_html( '40 MB' ); ?></td>
                        </tr>
                        <tr>
                            <td><?php esc_html_e( 'PHP Time Limit:', 'easy-elements' ); ?></td>
                            <td><?php echo esc_html( '120' ); ?></td>
                        </tr>
                        <tr>
                            <td><?php esc_html_e( 'PHP Max Input Vars:', 'easy-elements' ); ?></td>
                            <td><?php echo esc_html( '1000' ); ?></td>
                        </tr>
                        <tr>
                            <td><?php esc_html_e( 'MySQL Version:', 'easy-elements' ); ?></td>
                            <td><?php echo esc_html( '10.4.32' ); ?></td>
                        </tr>
                        <tr>
                            <td><?php esc_html_e( 'Max Upload Size:', 'easy-elements' ); ?></td>
                            <td><?php echo esc_html( '40 MB' ); ?></td>
                        </tr>
                    </tbody>
                </table>
...
<div id="support" class="ele-body-wrapper">
    <div class="ele-elements-dashboard-wrapper ele-support">
        <div class="ele-feature-request-wrapper">
            <div class="ele-feature-request-header">
                <img src="<?php echo esc_url( ELE_PLUGIN_URL . 'assets/admin/' ); ?>images/request.svg" alt="" />
                <h3 class="ele-secondery-heading"><?php esc_html_e( 'Request Features', 'easy-elements' ); ?></h3>
            </div>
            <p class="ele-secondery-p">
                <?php esc_html_e( 'Enhance your website with our custom Elementor plugin. Get tailored features, advanced styling, responsive design, and seamless integration. Choose instant feature deployment or benefit from regular free updates. Transform your site with interactive elements and dynamic content.', 'easy-elements' ); ?>
            </p>
            <ul class="ele-secondery-p ele-mb-24 ele-white ele-support-features">
                <li><?php esc_html_e( 'Tailored Solutions', 'easy-elements' ); ?></li>
                <li><?php esc_html_e( 'Rapid Deployment for an additional charge', 'easy-elements' ); ?></li>
                <li><?php esc_html_e( 'Free Updates for essential features', 'easy-elements' ); ?></li>
            </ul>
            <a class="ele-button" href="https://wa.me/+8801518376775" target="_blank"><?php esc_html_e( 'Request a Feature', 'easy-elements' ); ?></a>
        </div>

        <div class="ele-template-library-wrapper ele-box-shadow">
            <div class="ele-template-library">
                <img src="<?php echo esc_url( ELE_PLUGIN_URL . 'assets/admin/' ); ?>images/request.svg" alt="" />
                <h3 class="ele-secondery-heading"><?php esc_html_e( 'Technical Support', 'easy-elements' ); ?></h3>
            </div>
            <p class="ele-secondery-p">
                <?php esc_html_e( 'We provide dedicated technical support for our custom Elementor plugin. Get expert assistance for troubleshooting, feature customization, and seamless updates. Contact us for prompt and reliable support!', 'easy-elements' ); ?>
            </p>
            ...
            <a class="ele-button" href="https://wa.me/+8801518376775" target="_blank"><?php esc_html_e( 'Get Support', 'easy-elements' ); ?></a>
        </div>
    </div>
</div>
